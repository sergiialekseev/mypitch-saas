...
const LiveSession: React.FC<LiveSessionProps> = ({ topic, userName, sessionId, onReportReady }) => {
    ...
    <Paper sx={{ p: 4, position: "relative", overflow: "hidden" }}>
      <Stack spacing={3}>
        ...
        <Stack direction="row" spacing={2} justifyContent="flex-end">
          <Button variant="outlined" onClick={toggleMic} disabled={status !== "connected"}>
            {isMicMuted ? "Unmute" : "Mute"}
          </Button>
          <Button variant="contained" color="secondary" onClick={handleEndClick}>
            End session
          </Button>
        </Stack>
      </Stack>
